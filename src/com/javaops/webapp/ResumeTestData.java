...
public class ResumeTestData {
    public static void main(String[] args) {
        ...
        resume.addSection(SectionType.EXPERIENCE, new OrganizationAbstractSection(new Organization(new Link("Java Online Projects", "http://javaops.ru"), "Автор проекта.",
                ...
                new Organization(new Link("Java Online Projects", "http://javaops.ru"), "Автор проекта.",
                        "Создание, организация и проведение Java онлайн проектов и стажировок.", YearMonth.of(2013, 10), YearMonth.now())));
        resume.addSection(SectionType.EDUCATION, new OrganizationAbstractSection(new Organization(new Link("Coursera", "https://www.coursera.org/course/progfun"), "Functional Programming Principles in Scala by Martin Odersky", "", YearMonth.of(2013, 03), YearMonth.of(2013, 05))));
